  ...
  const results = useMemo(() => {
    ...
    try {
      ...
      const breakdownData = [
        ...
        { category: 'Daily Calories', value: `${dailyCalories.toFixed(0)} calories/day` },
  ...
  const chartConfig = (results) => ({
    ...
    pie: {
      data: {
        labels: ['BMR', 'Activity'],
        datasets: [{
          data: [parseFloat(results.bmr), parseFloat(results.tdee) - parseFloat(results.bmr)],
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-2">
          Calculate your Body Mass Index with comprehensive health insights including BMR, TDEE, and personalized calorie recommendations.
        </p>
      </div>
            ...
            <>
              ...
              <div className="card bg-gradient-to-br from-primary/5 to-transparent">
                <div className="text-center mb-6">
                  <h2 className="text-xl font-semibold mb-2">Your BMI Results</h2>
                ...
                <div className="flex flex-col items-center justify-center py-4">
                  ...
                  <div className={`text-xl font-semibold mb-4 ${results.color}`}>
                    {results.category}
                  </div>
      ...
      <div className="card mt-8">
        <h2 className="text-xl font-semibold mb-4">Health Insights & Recommendations</h2>
        <div className="space-y-6">
          <div>
            ...
            {results && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 border border-border rounded-lg">
                  <div className="text-sm text-text/60">Basal Metabolic Rate (BMR)</div>
                  <div className="text-xl font-bold">{results.bmr} calories/day</div>
                  <p className="text-sm text-text/60 mt-1">Calories burned at rest</p>
                </div>
                <div className="p-4 border border-border rounded-lg">
                  <div className="text-sm text-text/60">Total Daily Energy Expenditure (TDEE)</div>
                  <div className="text-xl font-bold">{results.tdee} calories/day</div>
                  <p className="text-sm text-text/60 mt-1">Calories burned with activity</p>
                </div>
                <div className="p-4 border border-border rounded-lg">
                  <div className="text-sm text-text/60">Daily Calorie Target</div>
                  <div className="text-xl font-bold">{results.dailyCalories} calories/day</div>
                  <p className="text-sm text-text/60 mt-1">For {results.goal.replace('Weight', '').toLowerCase()}ing weight</p>
                </div>
              </div>
            )}
          </div>
            ...
            <div className="space-y-3">
              {results?.category.includes('Thinness') ? (
                <>
                  <div className="flex items-start p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                    ...
                    <div>
                      <p className="font-medium">Focus on healthy weight gain</p>
                      <p className="text-sm text-text/60">Increase calorie intake with nutrient-dense foods and include strength training</p>
                    </div>
                  </div>
                </>
                ...
                <>
                  <div className="flex items-start p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    ...
                    <div>
                      <p className="font-medium">Maintain your healthy weight</p>
                      <p className="text-sm text-text/60">Continue balanced nutrition and regular physical activity</p>
                    </div>
                  </div>
                </>
              ) : (
                <>
                  <div className="flex items-start p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    ...
                    <div>
                      <p className="font-medium">Consider gradual weight management</p>
                      <p className="text-sm text-text/60">Aim for 1-2 lbs (0.5-1 kg) weight loss per week through diet and exercise</p>
                    </div>
                  </div>
                </>
              )}
              ...
              <div className="flex items-start p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-text/60">
                    BMI is a screening tool. It doesn't account for muscle mass, bone density, or body composition. 
