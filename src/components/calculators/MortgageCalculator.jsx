    ...
    try {
      ...
      if (paymentSchedule === "acceleratedBiweekly") {
        periodicPayment =
          (loanAmount *
            (interestRate / 12) *
            Math.pow(1 + interestRate / 12, termYears * 12)) /
      ...
      const pmiMonthly =
        downPayment / homePrice < 0.2 ? (loanAmount * pmiRate) / 12 : 0;
      const monthsUntilPMIEnd =
        downPayment / homePrice < 0.2
          ? Math.ceil(
              (0.2 * homePrice - downPayment) /
                (periodicPayment * (1 - interestRate / paymentsPerYear))
            )
          : 0;
      ...
      while (balance > 0.01 && month <= termYears * 12) {
        ...
        schedule.push({
          ...
          payment:
            periodicPayment + (month >= extraPaymentStart ? extraPayment : 0),
          principal,
          interest,
      ...
      const scheduleWithoutExtra = calculateAmortizationSchedule(
        loanAmount,
        interestRate,
        termYears
      );
          ...
          {results && (
            <>
              ...
              <div className="card bg-gradient-to-br from-primary/5 to-transparent">
                ...
                <div className="space-y-2 mt-6">
                  ...
                  {results.pmiMonthly > 0 && (
                    <div className="flex justify-between items-center py-2">
                      <span className="text-text/70">
                        PMI (until month {results.monthsUntilPMIEnd})
                      </span>
                      <span className="font-medium">
                        $
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="font-medium">
                      $
                      {results.homeInsuranceMonthly.toLocaleString("en-US", {
                        minimumFractionDigits: 2,
                      })}
                    </span>
                  </div>
                  {results.hoaFeesMonthly > 0 && (
                    <div className="flex justify-between items-center py-2">
                      ...
                      <span className="font-medium">
                        $
                        {results.hoaFeesMonthly.toLocaleString("en-US", {
                          minimumFractionDigits: 2,
                        })}
                      </span>
                    </div>
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 gap-3">
                <div className="card">
                  <div className="text-xs sm:text-sm text-text/60 mb-1">
                    Total Loan Amount
                  </div>
                ...
                <div className="card">
                  ...
                  <div className="text-xl font-bold">
                    ...
                    {results.summary.downPaymentPercent}%)
                  </div>
                </div>
                <div className="card">
                ...
                <div className="card bg-gradient-to-br from-green-50 to-transparent dark:from-green-900/20">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-3 border border-green-200 dark:border-green-800 rounded-lg">
                      ...
                      <div className="text-xl font-bold text-green-600">
                        {Math.floor(results.timeSavingsMonths / 12)} years,{" "}
                        {results.timeSavingsMonths % 12} months
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {results && (
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    ${results.homePrice.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span>PMI</span>
                  <span className="font-medium">
                    ${results.totalPMI.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    ${results.totalInsurance.toLocaleString()}
                  </span>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium capitalize">
                    {results.paymentSchedule.replace(/([A-Z])/g, " $1")}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Payments per Year</span>
                  <span className="font-medium">
                    {results.paymentSchedule === "monthly" ? 12 : 26}
                  </span>
                </div>
                <div className="flex justify-between">
